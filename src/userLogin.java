...
//	Create a global variable
	...
	private void initialize() {
		...
		lblUsername.setIcon(new ImageIcon(userLogin.class.getResource("/img/users.png")));
		lblUsername.setFont(new Font("Dialog", Font.BOLD, 25));
		lblUsername.setBounds(269, 105, 169, 40);
		frame.getContentPane().add(lblUsername);
		
		JLabel lblPassword = new JLabel("Password");
		lblPassword.setIcon(new ImageIcon(userLogin.class.getResource("/img/pass.png")));
...
//		Add Image tolabel
		Image userImg = new ImageIcon(this.getClass().getResource("img/yanks1.jpeg")).getImage(); //use this class, and use its resources in img and get imgage
		...
		btnBackToMain.setIcon(new ImageIcon(userLogin.class.getResource("/img/cancel.png")));
